...
**Test Templates**:
- "Unit test template?" → [`test-3tier-strategy`](../../.gemini/skills/12-testing-strategies/test-3tier-strategy.md) - See Tier 1 section
- "Integration test template?" → [`test-3tier-strategy`](../../.gemini/skills/12-testing-strategies/test-3tier-strategy.md) - See Tier 2 section
- "E2E test template?" → [`test-3tier-strategy`](../../.gemini/skills/12-testing-strategies/test-3tier-strategy.md) - See Tier 3 section

**Testing Infrastructure**:
- "Docker setup for tests?" → [`test-3tier-strategy`](../../.gemini/skills/12-testing-strategies/test-3tier-strategy.md) - See Tier 2 section
- "Fixture patterns?" → [`test-3tier-strategy`](../../.gemini/skills/12-testing-strategies/test-3tier-strategy.md)
