...
**Docker Basics**:
- "Docker Compose setup?" → [`deployment-docker-quick`](../../.gemini/skills/10-deployment-git/deployment-docker-quick.md)
- "Environment variables?" → [`deployment-docker-quick`](../../.gemini/skills/10-deployment-git/deployment-docker-quick.md)
- "Health checks?" → [`deployment-kubernetes-quick`](../../.gemini/skills/10-deployment-git/deployment-kubernetes-quick.md)

**Production Patterns**:
- "Secrets management?" → [`deployment-docker-quick`](../../.gemini/skills/10-deployment-git/deployment-docker-quick.md)
- "Resource limits?" → [`deployment-kubernetes-quick`](../../.gemini/skills/10-deployment-git/deployment-kubernetes-quick.md)
- "Production checklist?" → [`deployment-kubernetes-quick`](../../.gemini/skills/10-deployment-git/deployment-kubernetes-quick.md)
